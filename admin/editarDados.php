<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
       ...
       $id_treino = $_POST['id_treino'];
            ...
            $alterado = atualizandoDados($pdo, $id_treino, $serie, $obs);

            if($alterado){
                    alerta("Dados alterados com sucesso!");
            } else {
                    alerta("Falha ao alterar dados!");
            }
        ...
        <section class="adicionar">
            <form class="formulario" action="" method="POST">
                ...
                <div class="formulario__div" >
                    <label class="formulario__div__label" for="">Série</label>
                    <input type="hidden" name='id_treino' value="<?= $id_treino; ?>">
                    <input class="formulario__div__input" value="<?= $treino['serie']; ?>" type="text" name="serie">
                </div>

                <div class="formulario__div">
                    <label class="formulario__div__label" for="">Obs</label>
                    <input class="formulario__div__input" type="text" value="<?= $treino['obs']; ?>" name="obs">
                </div>
